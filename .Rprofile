#
#  This file defines variables and executes code on R startup
#

cat("commands executing from ~/.Rprofile\n")

# Define a variable pointing to the directory where you have cloned
